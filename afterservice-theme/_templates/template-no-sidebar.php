...
<?php
    ...
    if( have_rows('subpage') ):
                ...
                <div class="o-container">
                    ...
                    <div class="o-row">
                        ...
                        <div class="o-col--xxs-12">
                            ...
                            <?php if ( get_sub_field('block_2_awards_title') ): ?>
                            
                                <h2 class="u-h3 u-text--line u-text--dark-blue u-text--center">
                                    <?php the_sub_field('block_2_awards_title'); ?>
                                </h2>
                            ...
                            <?php if( get_sub_field('block_2_awards_blocks') ): ?>
                                ...
                                <div class="c-awards__content u-block-padding--lg c-block--flex c-block--flex-v-center c-block--flex-around u-text--center">
        ...
        ?>
            ...
            <div class="c-info-cta u-block-padding--lg">
                        ...
                        <div class="o-col--xxs-12 o-col--md-12">
                            ...
                            <?php if ( $title ): ?>
                                ...
                                <div class="c-info-cta__title">
                                    ...
                                    <h3 class="u-reset-font--tertiary u-reset--margin"><?php echo $title; ?></h3>
        ...
        ?>
            ...
            <div class="c-cases-block u-block-padding--sm">
            ...
            <?php elseif( get_row_layout() == 'block_6_contact_info' ): 

                $title = get_sub_field('block_6_contact_info_title');
                $content = get_sub_field('block_6_contact_info_content');

            ?>

            <!-- Section -->

            <div class="c-contact-info u-block-padding--lg">
            ...
            <div class="c-video u-block-padding--lg">
            ...
            <div class="c-cta-info u-block-padding--lg">
        ...
        <?php elseif( get_row_layout() == 'block_9_services' ): 
            ...
            <div class="c-services u-block-padding--md">
