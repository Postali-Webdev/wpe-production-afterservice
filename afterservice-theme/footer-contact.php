        ...
        <div class="o-container">
            ...
            <div class="o-row">
                ...
                <div class="o-col--xxs-12 u-text--center">
                    ...
                    <p class="c-footer__credits u-reset--margin"><?php echo bloginfo('name'); ?> &copy; <?php echo date('Y'); ?>. All Rights Reserved. Powered By <a href="https://www.matadorsolutions.net/" target="_blank">Matador Solutions</a></p> <br>
